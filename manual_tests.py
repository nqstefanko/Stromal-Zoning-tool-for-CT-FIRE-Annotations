...
if plot_tests:
    ...
    def test_plot_fibers():
        ...
        # all_verts = CTF_OUTPUT.set_fibers(0)
        # print(len(all_verts))
...
if nums_tests:
    def test_getting_averages():
        ...
        angles = CTF_OUTPUT.get_fiber_angles_thresholded()
    ...
    def test_get_signal_density_only_in_stromal_region():
        ...
        singnal_dens_only_stromal = get_signal_density_per_desired_zones(lengths, widths, final_union_of_zones, bucketed_fibers, [1,2,3])
